...
5 7 * * * conda activate gcp-thingspeak;python /home/jf/Documents/projects/thermoflux-particle-gcp-python/create_report/create_report.py >> /home/jf/Documents/projects/thermoflux-particle-gcp-python/cron.log 2>&1;conda deactivate
...
if __name__ == "__main__":
    ...
    for SITE in sites:
        ...
        upload_blob(reports_bucket_name, FIGNAME, "report.png", storage_client)
