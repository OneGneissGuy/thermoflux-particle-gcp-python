...
# matplotlib.rcParams.update({"axes.facecolor": "snow"})
# matplotlib.rcParams.update({"image.cmap": "tab10"})
...
def readfile(input_filename):
    """Function to read a data file and return a data frame
    with headers and pandas date_time index ."""
    try:
        df = pd.read_csv(
            input_filename,
            index_col=0,
        ...
        print("Could not read {}".format(input_filename))
...
if __name__ == "__main__":
    FILENAME = r"demo-table-export.csv"
