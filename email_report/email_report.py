...
def email_report():
    ...
    # to = To("report-testing@googlegroups.com", "jfsaraceno@gmail.com")
    ...
    message = Mail(
        ...
        to_emails=to_email,  # "jfsaraceno@gmail.com",  # "LandIQ-data-reports@googlegroups.com",
